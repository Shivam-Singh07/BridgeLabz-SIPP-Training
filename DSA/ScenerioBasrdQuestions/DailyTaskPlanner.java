/*
 * Daily Task Planner – LinkedList + Abstraction
Scenario:
A digital planner keeps a list of tasks added by the user in sequence.
Requirements:
● LinkedList<Task> with Task as an abstract class
● Subclasses: Meeting, Workout, CodingSession
● Each task should override an abstract execute() method.
● Allow the user to search by keyword (Linear Search)
Focus Concepts: LinkedList, Abstraction, Inheritance, Linear Search
 */
