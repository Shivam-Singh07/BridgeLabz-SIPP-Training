/*
 Event Ticketing System – Queue + HashMap + Constructor Overloading
Scenario:
People queue to book tickets for events (concerts, plays). Events are mapped to their attendee
queues.
Requirements:
HashMap<String, Queue<Attendee>> → event name → booking queue
Class Attendee with name, age, and optional email
Use constructor overloading: one with email, one without
Implement method to get position of a person in the queue (linear)
Focus Concepts: Queue, HashMap, Constructor Overloading, Linear Search
 */
